...
/// <summary>
/// Commande permettant d'ajouter ou de supprimer une note centrale dans une cellule.
/// 
...
/// </summary>
public class ToggleCenterNoteCommand : ISudokuCommand
{
    /// <summary>
    ...
    /// <summary>
    /// Note centrale à ajouter ou supprimer.
    ...
    /// <summary>
    /// Crée une commande de modification d'une note centrale.
    /// </summary>
    /// <param name="cell">Cellule à modifier.</param>
    /// <param name="note">Note à ajouter ou supprimer, entre 1 et 9.</param>
    public ToggleCenterNoteCommand(SudokuCell cell, int note)
    {
    ...
    public void Execute()
    {
        ...
        if (_cell.CenterNotes.Contains(_note))
        {
            _cell.CenterNotes.Remove(_note);
        }
        else
        {
            _cell.CenterNotes.Add(_note);
        }
